...
using BaseInfrastructure.Cache;
...
namespace BaseAdmin.WebApi.Controllers
{
    ...
    public class ArticleController : BaseController
    {
        ...
        {
            var predicate = Expressionable.Create<BaseServiceCore.Model.Article>();
        ...
        {
            var addModel = parm.Adapt<BaseServiceCore.Model.Article>().ToCreate(context: HttpContext);
        ...
        public IActionResult Update([FromBody] ArticleDto parm)
        {
            ...
            var modal = parm.Adapt<BaseServiceCore.Model.Article>().ToUpdate(HttpContext);
        ...
        public IActionResult Top([FromBody] BaseServiceCore.Model.Article parm)
        {
        ...
        public IActionResult ChangePublic([FromBody] BaseServiceCore.Model.Article parm)
        {
