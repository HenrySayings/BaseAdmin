using BaseCodeGenerator;
using BaseCodeGenerator.Model;
using BaseCodeGenerator.Service;
using BaseCommon;
...
namespace BaseAdmin.WebApi.Controllers.System
{
    /// <summary>
    /// 代码生成
    /// </summary>
    ...
    public class CodeGeneratorController : BaseController
    {
        ...
        public IActionResult CodeGenerate([FromBody] GenerateDto dto)
        {
            ...
            //生成压缩包
            string zipReturnFileName = $"BaseAdmin.NET-{dto.GenTable.TableName}-{DateTime.Now:MMddHHmmss}.zip";
