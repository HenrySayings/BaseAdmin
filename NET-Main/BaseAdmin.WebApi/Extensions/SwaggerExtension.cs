using BaseAdmin.WebApi.Extensions;
...
namespace BaseAdmin.WebApi.Extensions
{
    public static class SwaggerExtension
    {
        ...
        public static void AddSwaggerConfig(this IServiceCollection services)
        {
            ...
            services.AddSwaggerGen(c =>
            {
                ...
                {
                    Title = "BaseAdmin.NET Api",
                    Version = "v1",
                    Description = "系统管理",
                    Contact = new OpenApiContact { Name = "BaseAdmin doc", Url = new Uri("https://www.izhaorui.cn/doc") }
                });
                ...
                try
                {
                    ...
                    c.IncludeXmlComments(Path.Combine(baseDir, "BaseModel.xml"), true);
                    c.IncludeXmlComments(Path.Combine(baseDir, "BaseServiceCore.xml"), true);
                    c.IncludeXmlComments(Path.Combine(baseDir, "BaseService.xml"), true);
                    c.IncludeXmlComments(Path.Combine(baseDir, "BaseAdmin.WebApi.xml"), true);
