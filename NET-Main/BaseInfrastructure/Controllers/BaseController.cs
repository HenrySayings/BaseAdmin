...
namespace BaseInfrastructure.Controllers
{
    ...
    public class BaseController : ControllerBase
    {
        ...
        {
            IWebHostEnvironment webHostEnvironment = (IWebHostEnvironment)App.App.ServiceProvider.GetService(typeof(IWebHostEnvironment));
        ...
        {
            IWebHostEnvironment webHostEnvironment = App.App.WebHostEnvironment;
