...
namespace BaseInfrastructure
{
    ...
    public class JwtUtil
    {
        ...
        public static TokenModel GetLoginUser(HttpContext httpContext)
        {
            ...
            return !string.IsNullOrEmpty(token) ? ValidateJwtToken(ParseToken(token)) : null;
        }
        ...
        public static TokenValidationParameters ValidParameters()
        {
            ...
            if (jwtSettings.SecretKey.IsEmpty())
            {
        ...
        private static JwtSecurityToken ParseToken(string token)
        {
            ...
            try
            {
                tokenHandler.ValidateToken(token, validateParameter, out var validatedToken);
